...
* [IA générative : plateforme HuggingFace et modalités d'accès aux LLM](ia-generative-modalites-dacces-aux-llm.md)
* [IA générative : domaines d'applications](ia-generative-domaines-dapplications.md)

## SISB : pistes d'implémentations

* [ML : outil d'aide aux acquisitions](sisb-pistes-dimplementations/ml-outil-daide-aux-acquisitions.md)
...
* [GenAI : moteur de recherche académique](sisb-pistes-dimplementations/genai-moteur-de-recherche-academique.md)
